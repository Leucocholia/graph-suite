...
Species expression. Recursively, the root has a two-element multiset of subtrees rather than an ordered pair of subtrees. The implementation builds ordered child pairs through `Combinatorial`, then keeps the canonical representative of each sibling order.
